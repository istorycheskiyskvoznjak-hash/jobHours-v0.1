...
export const BuildingOfficeIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M8.25 21V3.75h7.5V21M8.25 3.75h7.5M12 21v-9.75m0 0A2.25 2.25 0 0 1 9.75 9V6.75A2.25 2.25 0 0 1 12 4.5v0A2.25 2.25 0 0 1 14.25 6.75V9A2.25 2.25 0 0 1 12 11.25v0Z" />
    </svg>
);
...
export const TeamIconDetailed = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        {/* Central figure */}
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 12a3 3 0 100-6 3 3 0 000 6z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 15c-2.485 0-4.5 2.015-4.5 4.5V21h9v-1.5c0-2.485-2.015-4.5-4.5-4.5z" />
        {/* Left figure */}
        <path strokeLinecap="round" strokeLinejoin="round" d="M6 13a2 2 0 100-4 2 2 0 000 4z" opacity="0.6"/>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6 14c-1.657 0-3 1.343-3 3v1.5h4.5V17c0-.98-.445-1.85-1.147-2.43" opacity="0.6"/>
        {/* Right figure */}
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 13a2 2 0 100-4 2 2 0 000 4z" opacity="0.6"/>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 14c1.657 0 3 1.343 3 3v1.5h-4.5V17c0-.98.445-1.85 1.147-2.43" opacity="0.6"/>
    </svg>
);
...
export const IdentificationIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 11.25a2.25 2.25 0 1 1 4.5 0 2.25 2.25 0 0 1-4.5 0Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 15h10.5a.75.75 0 0 1 .75.75v.75a.75.75 0 0 1-.75.75H6.75a.75.75 0 0 1-.75-.75v-.75a.75.75 0 0 1 .75-.75Z" />
    </svg>
);
...
export const TeamIconWithHelmets = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        {/* Central figure */}
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 12a3 3 0 100-6 3 3 0 000 6z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 15c-2.485 0-4.5 2.015-4.5 4.5V21h9v-1.5c0-2.485-2.015-4.5-4.5-4.5z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 3.75h-3a1.5 1.5 0 000 3h3a1.5 1.5 0 000-3z" />
        {/* Left figure */}
        <path strokeLinecap="round" strokeLinejoin="round" d="M6 13a2 2 0 100-4 2 2 0 000 4z" opacity="0.6"/>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6 14c-1.657 0-3 1.343-3 3v1.5h4.5V17c0-.98-.445-1.85-1.147-2.43" opacity="0.6"/>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7 6.75h-2a1 1 0 000 2h2a1 1 0 000-2z" opacity="0.6"/>
        {/* Right figure */}
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 13a2 2 0 100-4 2 2 0 000 4z" opacity="0.6"/>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 14c1.657 0 3 1.343 3 3v1.5h-4.5V17c0-.98.445-1.85 1.147-2.43" opacity="0.6"/>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19 6.75h-2a1 1 0 000 2h2a1 1 0 000-2z" opacity="0.6"/>
    </svg>
);
